        ...
        return (
            <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-zinc-500 font-medium animate-pulse">جاري تحليل &quot;شخصية&quot; الفصل...</p>
                </div>
            </div>
        );
    }
        ...
        <main className="min-h-screen bg-zinc-950 text-zinc-100 font-sans p-6" dir="rtl">
            ...
            <div className="relative z-10 max-w-7xl mx-auto pb-20">
                ...
                <header className="flex justify-between items-center mb-10">
                    ...
                    <div className="bg-zinc-900/50 border border-white/5 px-4 py-2 rounded-2xl backdrop-blur-md text-xs text-zinc-400">
                    ...
                    <AnalyticsCard title="مستوى التحصيل الدراسي" subtitle="متوسط درجات الفصل في الاختبارات الأخيرة">
                        <div className="flex flex-col items-center justify-center py-6">
                            ...
                            <div className="flex items-center gap-2 mt-4">
                                ...
                                <span className="text-[10px] text-zinc-500 font-bold uppercase">+%٣.٤ مقارنة بالشهر السابق</span>
                            </div>
                        </div>
                    </AnalyticsCard>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <AnalyticsCard title="خريطة السلوك الزمني" subtitle="متى يكثر الشغب؟ توزيع المخالفات حسب الحصص" className="lg:col-span-2">
                        <div className="grid grid-cols-8 gap-1 h-[280px]">
                            ...
                            {[1, 2, 3, 4, 5, 6, 7].map(p => <div key={p} className="text-center text-[9px] font-black text-zinc-500">ح{p}</div>)}
                                ...
                                <React.Fragment key={day}>
                                    ...
                                    {[1, 2, 3, 4, 5, 6, 7].map(p => {
                                        ...
                                        return (
                                            <div
                                                key={p}
                                                className="aspect-[2/1] bg-rose-500 rounded border border-white/5 transition-all"
                        ...
                        <div className="mt-4 flex justify-end gap-4 text-[9px] text-zinc-500 font-black">
                    ...
                    <AnalyticsCard title="تحليل توافق المعلمين" subtitle="العلاقة بين المعلم وسلوك الفصل">
                        <div className="space-y-6 pt-4">
                            <div className="p-4 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 group hover:bg-emerald-500/10 transition-all">
                                ...
                                <h4 className="text-sm font-bold text-zinc-100">{stats.heroTeacher}</h4>
                            ...
                            <div className="p-4 rounded-2xl bg-rose-500/5 border border-rose-500/20 group hover:bg-rose-500/10 transition-all">
                                ...
                                <h4 className="text-sm font-bold text-zinc-100">{stats.needsImprovementTeacher}</h4>
                        ...
                        <div className="mt-4 space-y-2">
                            {stats.massAttendance.slice(0, 2).map((ma, i) => (
                                <div key={i} className="flex justify-between items-center p-3 rounded-xl bg-white/5 text-[10px]">
                                    <span className="text-zinc-400">{ma.date}</span>
                    ...
                    <AnalyticsCard title="منظومة التأثير الطلابي" subtitle="الطلاب الـ ٥ الأكثر تأثيراً في مناخ الفصل">
                        <div className="space-y-4 pt-2">
                            {stats.influentialStudents.map((s, i) => (
                                <div key={i} className="flex items-center justify-between p-3 rounded-2xl bg-white/5 border border-white/5 group hover:bg-zinc-800/50 transition-all">
                                    ...
                                    <div className="flex flex-col items-end">
                                        <div className="text-[10px] font-black text-zinc-500 uppercase">{s.type === 'positive' ? 'محفز للطاقة' : 'بؤرة توتر'}</div>
