 ...
 * سجلّ القوالب/الأكواد لكل مدرسة (tenant template registry) = مُمرآة الآن في سجلّ المستأجرين `lib/quality/tenant-templates.ts` (module 'secretary'، المصدر المعتمد للأكواد). TODO: ربط الإتاحة المدرسية بالسجلّ على مستوى المُستدعي (بعد تسجيل برنامج المدرسة).
 */
