...
// ملاحظة (Phase 2C): أُزيلت من هذا الملف النسخ المكررة الميتة من دوال الفصول/الجدول
// (getSchoolClassrooms · getClassTimetable · getSchoolTeachers · assignTeacherToSlot ·
//  createClass · checkClassName · resetSchoolClasses). المصدر الوحيد المعتمد لهذه الدوال
// هو app/_actions/coordinator-classroom.ts (النسخة المحصَّنة بعزل المستأجر). لم تكن أيٌّ من
// النسخ المحذوفة مستوردة في أي مكان (أُثبت بالبحث)، وكانت نسخة getClassTimetable هنا غير مقيَّدة
// بـ school_id. هذا الملف الآن مخصص لإجراءات الموظفين فقط (getSchoolStaff · createStaff).
