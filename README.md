...
* **نسبة الجاهزية المُقدَّرة:** **~85%**
  * **قاعدة البيانات:** مكتملة بنسبة 100% وتغطي الترحيلات من (`M01–M74 + R00–R12`) بإجمالي **77 ترحيل**.
...
db/
└── migrations/              — السجل التاريخي والترجيلات الخاصة بقاعدة البيانات (M01–M74 + R00–R12 بإجمالي 77 ترحيل)
