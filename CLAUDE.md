...
- **بيانات التجربة:** لا seed/demo معتمد؛ **لم تُزرع بيانات حيّة**. قائمة البيانات المطلوبة للتحقّق الحيّ بالمتصفّح موثّقة في `CURRICULUM_PROGRESS_FEATURE_AUDIT.md` (Phase 6).
