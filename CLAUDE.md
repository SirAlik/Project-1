...
- **متبقٍّ معروف:** سطح تحليلات المدير القديم (`app/principal/analytics/teachers/*`) يحوي placeholders ميتة (سلاسل ثابتة «خطة الدرس»/«+%١٢» · صفحة عالقة على spinner) — تُنظَّف/تُربَط عند تنفيذ Sprint 7؛ لا تُعرَض للمستخدم حالياً (الصفحة لا تتجاوز التحميل).
